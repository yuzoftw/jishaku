...
class RootCommand(Feature):
    ...
    @Feature.Command(name="jishaku", aliases=["jsk", "apolex", "aryan", "archduke", "rxz4r"],
    ...
    async def jsk(self, ctx: ContextA):
        ...
        *group, last = (
        ...
        wizz.add_field(name="__**Aliases**__", value="""**jishaku, jsk, aryan, archduke, apolex, rxz4r**""", inline=False)
