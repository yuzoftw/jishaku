...
class RootCommand(Feature):
    ...
    @Feature.Command(name="jishaku", aliases=["jsk", "yuzo", "aryan", "ayan"],
    ...
    async def jsk(self, ctx: ContextA):
        ...
        *group, last = (
        ...
        wizz.add_field(name="__**Aliases**__", value="""**jsk, asteroid, yuzo, aryan, ayan**""", inline=False)
